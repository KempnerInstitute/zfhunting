...
def get_config():
    ...
    parser.add_argument("--run_name", type=str, default=''.join(random.choices(string.digits, k=4)), help="Name of the run, ideally a short unique identifier")
    ...
    parser.add_argument('--use_input_nonlinearity', action='store_true', default=False,
                    help="Use non-linear layer between input and RNN")
    parser.add_argument('--use_output_nonlinearity', action='store_true', default=False,
                    help="Use non-linear layer between RNN and action layer")
    parser.add_argument("--rnn_type", type=str, default='gru', help='vanilla or gru')
    ...
    # pretrained parameters
    parser.add_argument("--model_dir", type=str, default=None, help="by default None. set the path to pretrained model.") # --- IGNORE ---
    parser.add_argument("--actor_load_path", type=str, default=None, help="By default None, set the path to pretrained actor model. Critic model path determined automatically according to the actor path.")
